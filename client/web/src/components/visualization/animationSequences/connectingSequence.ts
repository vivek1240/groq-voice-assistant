export const generateConnectingSequence = (rows: number, columns: number, ringDistance: number) => {
  let seq = [];
...
export const generateConnectingSequenceBar = (columns: number): number[] | number[][] => {
  let seq = [];
...
export const generateConnectingSequenceRadialBar = (columns: number): number[] | number[][] => {
  let seq = [];
