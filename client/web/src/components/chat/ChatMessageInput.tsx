  ...
  return (
    ...
    >
      <div className="flex flex-row pt-3 gap-2 items-center relative">
        <div
          className={`w-2 h-4 bg-black absolute left-2 ${
        ...
        <input
          ref={inputRef}
          className={`w-full text-xs caret-transparent bg-transparent opacity-75 text-black p-2 pr-6 rounded-sm focus:opacity-100 focus:outline-none focus:border-black focus:ring-1 focus:ring-black`}
          style={{
        ...
        <button
          ...
          onClick={handleSend}
          className={`text-xs uppercase text-black border border-black hover:bg-gray-950 hover:text-white p-2 rounded-md opacity-${
